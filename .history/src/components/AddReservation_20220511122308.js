     ...
     return (
              <div className="w-50 m-auto mt-5 shadow-sm p-3">
                   ...
                   <div className="form-group mt-2">
                        ...
                        <input onChange={Moha} name="date" className="form-control" type="datetime-local"/>
                   </div>
                   <div className="form-group mt-2">
                        <label className="form-label">Nombre de passagers</label>
                        <input onChange={Moha} name="nbrPassengers" className="form-control" type="number"  min="1" max="3"/>
                   </div>

                   <div className="form-group mt-2">
                        <label className="form-label">Class</label>
                        <select onChange={Moha} name = "classType" className="form-control">
